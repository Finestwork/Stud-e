...
<body>
    <main class="main-content">
        ...
        <p class="mail-text">We are sending you this email because you requested a password reset, click the button below to create a new password. Please be reminded that this link has only 1 hour duration, please do not share it.</p>
        <a href="{{route('verify.password.reset',$email_data['token'])}}" class="mail-link" style="color: white;">Reset password</a>
