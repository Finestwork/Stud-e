<aside class="sidebar" id="sidebar">
    <div class="scrollbar" id="scrollBar">
        @if(Request::path() !== 'teacher/classroom' && Request::path() !== 'teacher/classroom/create')
            <a class="sidebar__bttn bttn" href="{{ route('classroom.create') }}">
        ...
        @if(Request::path() == 'teacher')
            <a class="sidebar__icon-wrapper sidebar--active" href="{{ route('teacher.home') }}">
        ...
        @if(Request::path() == 'classroom' || Request::path() == 'classroom/create')
